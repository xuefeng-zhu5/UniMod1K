...
def main():
    ...
    parser.add_argument('--script', type=str,  default='spt', help='Name of the train script.')
    parser.add_argument('--config', type=str, default='unimod1k', help="Name of the config file.")
    ...
    parser.add_argument('--nproc', type=int, help='number of GPUs per node')
